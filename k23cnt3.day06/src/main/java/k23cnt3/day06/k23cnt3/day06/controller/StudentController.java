package k23cnt3.day06.k23cnt3.day06.controller;

import k23cnt3.day06.k23cnt3.day06.entity.Student;
import k23cnt3.day06.k23cnt3.day06.dto.StudentDTO;
import k23cnt3.day06.k23cnt3.day06.service.StudentService;
...
public class StudentController {
    ...
    @PostMapping
    public String saveStudent(@ModelAttribute("student") StudentDTO
                                      student) {
    ...
    public String updateStudent(@PathVariable(value = "id") Long
                                        id,@ModelAttribute("student") StudentDTO student) {
